...
#####  read resource  #####
note_normal = Image.open("images/notes_normal.png")
note_crtcl = Image.open("images/notes_crtcl.png")
note_long = Image.open("images/notes_long.png")
note_long_among = Image.open("images/notes_long_among.png")
note_long_among_crtcl = Image.open("images/notes_long_among_crtcl.png")
note_long_among_unvisible = Image.open("images/note_long_among_unvisible.png")
note_long_among_unvisible_crtcl = Image.open("images/note_long_among_unvisible_crtcl.png")
note_flick = Image.open("images/notes_flick.png")
note_flick_arrow = {
    1: [],
    3: [],
    4: []
...
for i in range(1, 7):
    note_flick_arrow[1].append(Image.open("images/notes_flick_arrow_%02d.png" % i))
    note_flick_arrow[3].append(Image.open("images/notes_flick_arrow_%02d_diagonal.png" % i))
    note_flick_arrow[4].append(Image.open("images/notes_flick_arrow_%02d_diagonal.png" % i).transpose(Image.FLIP_LEFT_RIGHT))
    note_flick_arrow_crtcl[1].append(Image.open("images/notes_flick_arrow_crtcl_%02d.png" % i))
    note_flick_arrow_crtcl[3].append(Image.open("images/notes_flick_arrow_crtcl_%02d_diagonal.png" % i))
    note_flick_arrow_crtcl[4].append(Image.open("images/notes_flick_arrow_crtcl_%02d_diagonal.png" % i).transpose(Image.FLIP_LEFT_RIGHT))
            ...
            for i in range(len(list)):
                ...
                if note_type == 0 and note_length == 0:
                    ...
                    if note_info[note_type] == 'normal':
                        ...
                        x = image_left_right + int(tempunitid / 4) * (unit_width + delta_unit_width)
                        y = image_height - (tempunitid % 4) * unit_height - image_top_bottom
                        draw.text((x - font.getsize('Skill')[0] - 5, y - 48), 'Skill', font=font, fill=(255, 255, 255))
